...
export const MAX_URL = "https://max.ru/tulbeton";
    ...
    return (
      <div className="grid grid-cols-2 gap-2">
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center gap-2 h-12 rounded-md bg-[#229ED9] text-white font-semibold"
        >
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center gap-2 h-12 rounded-md bg-primary text-primary-foreground font-semibold"
        >
          <MaxIcon /> МАКС
        </a>
      </div>
  ...
  return (
    <div className="flex flex-wrap gap-2">
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center gap-2 rounded-full bg-[#229ED9] text-white px-4 py-2 text-sm font-semibold hover:opacity-90 transition"
      >
        <TelegramIcon /> Telegram
      </a>
      <a
        ...
        target="_blank"
        rel="noopener noreferrer"
        className="inline-flex items-center gap-2 rounded-full bg-white text-primary px-4 py-2 text-sm font-semibold hover:bg-white/90 transition"
      >
        <MaxIcon /> МАКС
      </a>
    </div>
