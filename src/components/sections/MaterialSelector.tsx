      ...
      <div className="mt-12 grid gap-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4">
        {TASKS.map((t) => (
          <a key={t.title} href="#calculator"
            className="group relative flex flex-col rounded-lg border border-border bg-background p-6 shadow-card transition-all hover:-translate-y-0.5 hover:shadow-card-hover hover:border-accent">
            <span className="grid h-11 w-11 place-items-center rounded-sm bg-accent text-accent-foreground">
